...
/**
 * Api services for the `PackageSchedule` model.
 */
@Injectable()
export class PackageScheduleApi extends BaseLoopBackApi {
  ...
  public findByIdAnswers(id: any, fk: any): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/PackageSchedules/:id/answers/:fk";
    let _routeParams: any = {
      id: id,
      fk: fk
    };
  ...
  public countAnswers(id: any, where: any = {}): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/PackageSchedules/:id/answers/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
