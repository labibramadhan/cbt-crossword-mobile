...
export class PersonApi extends BaseLoopBackApi {
   ...
   * </em>
   */
  public registerGuru(user: any): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Persons/registerGuru";
    let _routeParams: any = {};
    let _postBody: any = {
      user: user
    };
   ...
   * </em>
   */
  public registerParticipant(user: any): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Persons/registerParticipant";
    let _routeParams: any = {};
    let _postBody: any = {
      user: user
    };
   ...
   * </em>
   */
  public findByRoles(roles: any, filter: LoopBackFilter = {}): Observable<Person> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Persons/findByRoles";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
    if (roles) _urlParams.roles = roles;
    if (filter) _urlParams.filter = filter;
    let result = this.request(_method, _url, _routeParams, _urlParams, _postBody);
   ...
   *  - `count` – `{number}` - 
   */
  public countByRoles(roles: any, where: any = {}): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Persons/countByRoles";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
    if (roles) _urlParams.roles = roles;
  ...
  public getCurrent(): any {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() + "/Persons" + "/:id";
   ...
   * call to {@link sdk.Person#login} or
   * {@link sdk.Person#getCurrent}. Return null when there
  ...
  /**
   * @name sdk.Person#isAuthenticated
   *
