...
/**
 * Api services for the `AnswerItem` model.
 */
@Injectable()
export class AnswerItemApi extends BaseLoopBackApi {
   ...
   * </em>
   */
  public getAnswer(id: any, refresh: any = {}): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/AnswerItems/:id/answer";
